  ...
  },
  {
    ...
    description: (
      <ul className="space-y-2">
        <li><strong>Pháp luật là công cụ quyền lực:</strong> Pháp luật vừa là công cụ quyền lực của nhân dân, vừa là phương tiện để kiểm soát quyền lực nhà nước.</li>
        <li><strong>Tăng cường pháp chế:</strong> Nhà nước phải quản lý bằng Hiến pháp và pháp luật, không dùng biện pháp mệnh lệnh để quản lý.</li>
        <li><strong>Tuân thủ pháp luật:</strong> Yêu cầu toàn thể nhân dân và đặc biệt là cán bộ nhà nước phải <strong>tôn trọng, tuân thủ pháp luật</strong>T. Cán bộ, các cấp phải <strong>gương mẫu chấp hành Hiến pháp và pháp luật</strong>T.</li>
      </ul>
    ),
    ...
    <section id="practice" className="px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-16">
        <header className="space-y-4 text-center md:text-left">
          <p className="text-xs uppercase tracking-[0.35em] text-primary/80">Phần II</p>
          <h2 className="text-4xl font-semibold md:text-5xl">Nhà nước pháp quyền</h2>
          <p className="text-base leading-relaxed text-midnight/80 md:max-w-3xl">
            Hồ Chí Minh luôn chú trọng xây dựng Nhà nước dựa trên nền tảng pháp lý vững chắc, thượng tôn pháp luật và mang tính nhân nghĩa.
          </p>
        </header>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr] lg:items-start">
          ...
          <aside className="sticky top-32 hidden lg:flex flex-col gap-4 rounded-3xl bg-paper-texture p-6 shadow-xl ring-1 ring-[#d6c2a4]">
            <h3 className="text-2xl font-semibold text-primary">Nhà nước pháp quyền</h3>
            ...
            <figure className="overflow-hidden rounded-2xl border border-primary/20 bg-white/80">
              ...
              <figcaption className="px-4 py-3 text-center text-xs text-midnight/70">
                Chủ tịch Hồ Chí Minh ký Sắc lệnh số 22/SL ngày 25/2/1946, ban hành Hiến pháp năm 1946
              </figcaption>
            </figure>
          </aside>
        </div>
